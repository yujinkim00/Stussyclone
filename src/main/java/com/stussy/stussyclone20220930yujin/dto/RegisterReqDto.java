...
import com.stussy.stussyclone20220930yujin.dto.validation.ValidationGroups;
import lombok.Data;
...
public class RegisterReqDto {
    ...
    @NotBlank(message = "이름은 비워 둘 수 없습니다", groups = ValidationGroups.NotBlankGroup.class)  //디폴트 메세지가 있지만 지정도 할 수 있다
    ...
    @Size(min=8, max = 16, message = "비밀번호는 8자 부터 16자까지 입력 가능합니다", groups = ValidationGroups.SizeGroup.class)
